    ...
    <div className="flex flex-col justify-center items-center min-h-screen">
      <div>
        <pre>
          ...
          <code>{`9                System.out.print(matriz[`}<input type="text" value={campo7} onChange={(e) => setcampo7(e.target.value)} />{`][`}<input type="text" value={campo8} onChange={(e) => setcampo8(e.target.value)} />{`] + " "); // Imprimir el elemento actual\n`}</code>
          <code>{`10           }\n`}</code>
